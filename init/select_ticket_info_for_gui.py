...
from .events import EVT_TYPE_NOTIFY_MAIN_WINDOW, NotifyMainWindowEvent
...
class select:
    ...
    def emit_log(self, msg):
        wx.CallAfter(pub.sendMessage, 'log', msg=msg)
    ...
    def get_ticket_info(self):
        ...
        self.emit_log(u"*" * 20)
        self.emit_log(u"12306刷票小助手，最后更新于2018.9.21，请勿作为商业用途，交流群号：286271084")
        self.emit_log(u"当前配置：\n出发站：{0}\n到达站：{1}\n乘车日期：{2}\n坐席：{3}\n是否有票优先提交：{4}\n乘车人：{5}\n" \
              u"刷新间隔：随机(1-3S)\n候选购买车次：{6}\n僵尸票关小黑屋时长：{7}\n 下单接口：{8}\n".format \
                (
                from_station,
                to_station,
